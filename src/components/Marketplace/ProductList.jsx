...
class ProductList extends Component {
    ...
    onPressViewAllHandler() {
        ...
        navigation.navigate('marketplace-category', {
            products,
            productType
        });
    }
    ...
    onPressAreaHandler() {
        navigation.navigate('marketplace-area');
    }
    ...
    render() {
        ...
        if (!isInCategory) {
            if (products.length > 4) {
                ...
                previewProducts = previewProducts.splice(0, 2);
            }
        }
        ...
        return (
            <View style={styles.container}>
                {!isInCategory && (
                    <View>
                        <Text style={styles.categoryOptions}>{categoryTitle}</Text>
                        ...
                        <View style={styles.rightOption}>
                            {productType !== productTypes.RECOMMEND ? (
                                ...
                                <ExTouchableOpacity onPress={this.onPressAreaHandler} style={styles.btnHide}>
