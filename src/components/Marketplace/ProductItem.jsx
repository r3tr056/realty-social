...
export default class ProductItem extends Componet {
    constructor(props) {
        super(props);
    }
    ...
    onPressProductHandler() {
        ...
        navigation.navigate('marketplace-product-detail', {
            item
        });
    }
    ...
    render() {
        ...
        return (
            <ExTouchableOpacity onPress={this.onPressProductHandler.bind(this)} style={styles.container}>
