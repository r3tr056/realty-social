...
class Posts extends Component {
    ...
    onPressViewPostDetailHandler(id) {
        navigation.navigate('post-detail', { id });
    }
    ...
    render() {
        ...
        return (
            <View style={{...styles.container, display: hiddent ? 'none' : 'flex', marginTop : isShowPreview ? 0 : 10 }}>
                ...
                { isShowPreview && (
                    <View>
                        <TouchableOpacity style={styles.btnShowAll} onPress={showAllFn}>
